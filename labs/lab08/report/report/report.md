...
![Задание 8.4.4. Оптимальная рассадка по залам (1)](image/74.png){#fig:074 width=70%}

![Задание 8.4.4. Оптимальная рассадка по залам (2)](image/75.png){#fig:075 width=70%}
...
Теперь решим полученную задачу, найдя $x$ и $y$ ([@fig:045,@fig:048]).

![Задание 8.4.5. План приготовления кофе (1)](image/74.png){#fig:074 width=70%}

![Задание 8.4.5. План приготовления кофе (2)](image/75.png){#fig:075 width=70%}
